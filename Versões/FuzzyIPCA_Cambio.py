...
# Carrega dados pré-processados (exemplo)
...
cambio['alto'] = fuzz.trapmf(cambio_range, [4, 5, 6.1, 6.1])        
...
ipca['baixo'] = fuzz.trapmf(ipca_range, [0, 0, 0.2, 0.4])
...
regras.append(ctrl.Rule(cambio['baixo'] & selic['alto'], ipca['baixo']))
regras.append(ctrl.Rule(expectativas['baixo'] & cambio['baixo'], ipca['baixo']))
regras.append(ctrl.Rule(commodities['baixo'] & cambio['baixo'], ipca['baixo']))
